#ifndef OMD_FORCEBUOYANCY_H
#define OMD_FORCEBUOYANCY_H
...
{
public:
	ForceBuoyancy(std::string const &name, BodyRigid * body, Vect3 const &f, Vect3 const &forceLocation=Vect3(0,0,0),
							bool const &forceIsLocal=true, Vect3 const &t=Vect3(0,0,0), bool const &torqueIsLocal=true);
	ForceBuoyancy(std::string const &name, BodyRigid * body, std::vector<double> const &f, std::vector<double> const &forceLocation,
